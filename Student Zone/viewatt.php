                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 s">
                            <h2 class="pt-3 pb-4 pl-1 font-bold font-up deep-purple-text">View<span> Attendence</span></h2>
                        </div>              
                    </div>
...
{
	$id=$_SESSION["student"];
	$sql="select a.*, b.* from satt a, addstudent b where a.sid = b.id and b.sid='$id'";
