                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 s">
                            <h2 class="pt-3 pb-4 pl-1 font-bold font-up deep-purple-text">Alert<span> By Admin</span></h2>
                        </div>              
                    </div>
...
if($con==true)
{
	...
	<thead><tr><th>subject</th><th>Message</th><th>Date & Time</th></tr></thead>";
		
		while($row=mysqli_fetch_array($result))
		{
		echo "<tr><td><img src='images/new.png' height='30px' width='30px'/>".$row['subject']."</td><td>".$row['msg']."</td><td>".$row['date']."</td></table>";
		}
}
?>
		<!--table-->
