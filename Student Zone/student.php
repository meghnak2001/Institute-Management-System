    ...
    <div class="container-fluid mt-3">
        ...
        <div class="row justify-content-center" style="padding-top:20px">
            <div class="col-11 w-100 mt-2">
                <div class="col-sm-4  f-left"><a href="student.php" style="text-decoration:none"><div class="card bg1 text-center text-light height card-hover"><i class="fa fa-home font24 d-block my-auto"><h5 class="mt-1"><b>Dashboard</b></h5></i></div></a></div>
                <div class="col-sm-4 f-left"><a href="viewatt.php" style="text-decoration:none"><div class="card bg8 text-center text-light height card-hover"><i class="fa fa-plus-square font24 d-block my-auto"><h5 class="mt-1"><b>View Attendence</b></h5></i></div></a></div>
                <div class="col-sm-4 f-left"><a href="viewlecture.php" style="text-decoration:none"><div class="card bg3 text-center text-light height card-hover"><i class="fa fa-book font24 d-block my-auto"><h5 class="mt-1"><b>View Lecture</b></h5></i></div></a></div>
            </div>
            <div class="col-11 w-100 mt-4">
                <div class="col-sm-4 f-left"><a href="profile.php" style="text-decoration:none"><div class="card bg5 text-center text-light height card-hover"><i class="fa fa-user-circle-o font24 d-block my-auto"><h5 class="mt-1"><b>Profile</b></h5></i></div></a></div>
                ...
                <div class="col-sm-4 f-left"><a href="logout.php" style="text-decoration:none"><div class="card bg7 text-center text-light height card-hover"><i class="fa fa-sign-in font24 d-block my-auto"><h5 class="mt-1"><b>Logout</b></h5></i></div></a></div>
            </div>
        </div>
    </div>
<!---view notice--->
