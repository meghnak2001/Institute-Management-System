...
<head>
    ...
    <title>Admin/Faculty View Attendence</title>
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 s">
                            <h2 class="pt-3 pb-4 pl-1 font-bold font-up deep-purple-text">View Teacher<span> Attendence</span></h2>
                        </div>              
                    </div>
...
if($con==true)
{
	$sql="select a.*, b.* from tatt a, addteacher b where a.tid = b.id";
