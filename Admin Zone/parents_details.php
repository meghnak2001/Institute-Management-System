...
<head>
    ...
    <title>Admin/Parents Details</title>
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 s">
                            <h2 class="pt-3 pb-4 pl-1 font-bold font-up deep-purple-text">Parents<span> Details</span></h2>
                        </div>              
                    </div>
...
if($con==true)
{
	$sql="select* from addstudent ORDER BY year ASC";
	$result=mysqli_query($con,$sql);
	echo "<table id='example' class='table table-striped table-bordered' style='width:100%;margin-top:10px;'>
	<thead><tr><th>Name</th><th>Mobile</th><th>Student Name</th><th>Branch</th><th>Year</th><th>Parents Id</th></tr></thead>";
		while($row=mysqli_fetch_array($result))
		{
		echo "<tr><td>".$row['pname']."</td><td>".$row['pmob']."</td><td>".$row['sname']."</td><td>".$row['branch']."</td><td>".$row['year']."</td><td>".$row['pid']."</td</tr>";
		}
		echo "</table>";
}
?>
