...
<head>
    ...
    <title>Admin/Contact Mgmt</title>
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 s">
                            <h2 class="pt-3 pb-4 pl-1 font-bold font-up deep-purple-text">Enquiry<span> Management</span></h2>
                        </div>              
                    </div>
...
if($con==true)
{
	...
	<thead><tr><th>First Name</th><th>Last Name</th><th>College Name</th><th>Email</th><th>Address</th><th>Mobile</th><th>Message</th><th>Delete</th></tr></thead>";
		
		while($row=mysqli_fetch_array($result))
		{
		echo "<tr><td>".$row['first_name']."</td><td>".$row['last_name']."</td><td>".$row['clg_name']."</td><td>".$row['email']."</td><td>".$row['address']."</td><td>".$row['mobile']."</td><td>".$row['msg']."</td><td><a href='codes/deletecontact.php?d=".$row['email']."'><span class='fa fa-trash' style='color:red;font-size:25px;margin-left:50%' title='Click here to delete Record '></span></a></td></tr>";
		}
		echo "</table>";
}
?>
