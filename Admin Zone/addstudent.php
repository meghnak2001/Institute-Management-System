        ...
        <form action="codes/addstudent.php" method="post" enctype="multipart/form-data">
            ...
            <div class="form-content">
                ...
                <div class="input-group mb-3">
                    <input type="text" class="form-control" aria-label="Username" aria-describedby="basic-addon1" placeholder="Student Name" name="sname">
                </div>
                <div class="input-group mb-3">
                    <input type="email" class="form-control" aria-label="Username" aria-describedby="basic-addon1" placeholder="Student Email" name="semail">
                </div>
                <div class="input-group mb-3">
                    <input type="number" class="form-control" aria-label="Username" aria-describedby="basic-addon1" placeholder="Student Contact Number" name="smob">
                </div>
				<div class="input-group mb-3">
                    <input type="text" class="form-control" aria-label="Username" aria-describedby="basic-addon1" placeholder="Parents Name" name="pname">
                </div>
                <div class="input-group mb-3">
                    <input type="email" class="form-control" aria-label="Username" aria-describedby="basic-addon1" placeholder="Parents Email" name="pemail">
                </div>
                <div class="input-group mb-3">
                    <input type="number" class="form-control" aria-label="Username" aria-describedby="basic-addon1" placeholder="Parents Contact Number" name="pmob">
                </div>
				<div class="input-group mb-3">
                    <input type="number" class="form-control" aria-label="Username" aria-describedby="basic-addon1" placeholder="Student Aadhar Number" name="addhar">
                </div>
                <div class="input-group mb-3">
                     <select name="gender" class="custom-select" id="exampleFormControlSelect1">
                ...
                <div class="input-group mb-3">
				<select name="branch" class="custom-select" id="exampleFormControlSelect1">
				...
				<div class="input-group mb-3">
				<select name="year" class="custom-select" id="exampleFormControlSelect1">
                                    <option>Year</option>
                                    <option>1</option>
                                    <option>2</option>
									<option>3</option>
				...
				<div class="input-group mb-3">
                    <input type="date" class="form-control" aria-label="Username" aria-describedby="basic-addon1" placeholder="Exprience" name="dob">
                </div>
				<div class="input-group mb-3">
                    <textarea name="cadd"class="form-control" rows="3" aria-label="Username" aria-describedby="basic-addon1" placeholder="Current Address"></textarea>
                </div>
				<div class="input-group mb-3">
                    <textarea name="padd"class="form-control" rows="3" aria-label="Username" aria-describedby="basic-addon1" placeholder="Parmanent Address"></textarea>
                </div>
				<div class="input-group mb-3">
				<select name="district" class="custom-select" id="exampleFormControlSelect1">
                ...
                <div class="input-group mb-3">
                    <input type="file"  aria-label="name" aria-describedby="basic-addon1" name="profile">
                </div>
                <div class="input-group mb-3">
