...
<div id="right-panel" class="right-panel">
    ...
    <div class="container-fluid content">
        <form action="codes/anotice.php" method="post" enctype="multipart/form-data">
            
            <div class="form-content">
                <h4 style="font-weight: bold">Send Notice Here</h4>
                <div class="input-group mb-4">
                    <input type="text" class="form-control" required aria-label="Username" aria-describedby="basic-addon1" placeholder="Subject" name="sub">
                </div>
                
                <div class="input-group mb-4">
                    <textarea class="form-control" rows="4" required aria-label="Username" aria-describedby="basic-addon1" placeholder="Massege" name="msg"></textarea>
                </div>
				<div class="input-group mb-4">
                    <input type="date" disabled="disabled" class="form-control" aria-label="Username" aria-describedby="basic-addon1" >
                </div>
                <div class="input-group mb-4">
                    <input type="file"  aria-label="name" required aria-describedby="basic-addon1" name="profile">
                </div>
				
                <div class="input-group mb-4">
                    <button type="submit" class="btn btn-default"  style="min-width: 100px">Send Notice</button>
                </div>
            </div>
        </form>
    </div>
