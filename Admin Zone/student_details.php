                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 s">
                            <h2 class="pt-3 pb-4 pl-1 font-bold font-up deep-purple-text">Student<span> Details</span></h2>
                        </div>              
                    </div>
...
if($con==true)
{
	$sql="select* from addstudent ORDER BY branch DESC";
	$result=mysqli_query($con,$sql);
	echo "<table id='example' class='table table-striped table-bordered' style='width:100%;margin-top:10px;'>
	<thead><tr><th>Name</th><th>Mobile</th><th>Gender</th><th>Branch</th><th>Year</th><th>DOB</th><th>Address</th><th>District</th><th>Student Id</th><th>Profile</th><th>Delete</th></tr></thead>";
		while($row=mysqli_fetch_array($result))
		{
		echo "<tr><td>".$row['sname']."</td><td>".$row['smob']."</td><td>".$row['gender']."</td><td>".$row['branch']."</td><td>".$row['year']."</td><td>".$row['DOB']."</td><td>".$row['c_address']."</td><td>".$row['district']."</td><td>".$row['sid']."</td><td> <img src=simg/".$row['pic']." style='height:75px;width:75px;'></td><td><a href='codes/stdelete.php?d=".$row['semail']."'><span class='fa fa-trash' style='color:red;font-size:25px;margin-left:50%' title='Click here to delete Record '></span></a></td></tr>";
		}
		echo "</table>";
}
?>
