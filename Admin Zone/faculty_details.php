                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 s">
                            <h2 class="pt-3 pb-4 pl-1 font-bold font-up deep-purple-text">Faculty<span> Details</span></h2>
                        </div>              
                    </div>
...
if($con==true)
{
	$sql="select* from addteacher ORDER BY userid ASC";
	$result=mysqli_query($con,$sql);
	echo "<table id='example' class='table table-responsive table-bordered' style='width:100%;margin-top:10px;'>
	<thead><tr><th>Name</th><th>Email</th><th>Mobile</th><th>User Id</th><th>Picture</th><th>Delete</th></tr></thead>";
		while($row=mysqli_fetch_array($result))
		{
		echo "<tr><td>".$row['name']."</td><td>".$row['email']."</td><td>".$row['mob']."</td><td>".$row['userid']."</td><td> <img src=simg/".$row['pic']." style='height:75px;width:75px;'></td><td><a href='codes/dft.php?d=".$row['email']."'><span class='fa fa-trash' style='color:red;font-size:25px;margin-left:50%' title='Click here to delete Record '></span></a></td></tr>";
		}
		echo "</table>";
}
?>
