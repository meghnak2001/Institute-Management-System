...
if($con==true)
{
	...
	<thead><tr><th>Name</th><th>Email</th><th>Message</th><th>Picture</th><th>Star</th></tr></thead>";
		
		while($row=mysqli_fetch_array($result))
		{
		echo "<tr><td>".$row['name']."</td><td>".$row['email']."</td><td>".$row['msg']."</td><td><img src=simg/".$row['picture']." style='height:75px;width:75px;'></td><td>".$row['star']."</tr>";
		}
		echo "</table>";
}
?>
