...
{ 
	$id=$_SESSION["teacher"];
	$sql="select* from addteacher where userid='$id' limit 1";
	$result=mysqli_query($con,$sql);
        ...
        <div class="col-md-4 border-right">
			...
			<img class="rounded-circle mt-5" src="images/logo.png" width="90"><span class="font-weight-bold"><?php echo $row['name']; ?></span>
			<span class="text-black-50"><?php $email=$row['email']; echo $row['email']; ?></span><span>POLYGUIDE INSTITUTION</span></div>
        </div>
        <div class="col-md-8">
            <div class="p-3 py-5">
                <div class="d-flex justify-content-between align-items-center mb-3">
                    <div class="d-flex flex-row align-items-center back"><i class="fa fa-long-arrow-left mr-1 mb-1"></i>
                        <a href="teacher.php"><h6>Back to home</h6></a>
                    </div>
                    <h6 class="text-right">Edit Profile</h6>
                </div>
                <div class="row mt-2">
                    <div class="col-md-6"><input type="text" class="form-control" name="name" value="<?php echo $row['name']; ?>" placeholder="Name*" required></div>
                    <div class="col-md-6"><input type="text" class="form-control" name="dob" value="<?php echo $row['userid']; ?>"  placeholder="DOB*" disabled  required></div>
                </div>
                <div class="row mt-3">
                    <div class="col-md-6"><input type="text" class="form-control" name="mob"  value="<?php echo $row['mob']; ?>" placeholder="Phone number*" required></div>
					<div class="col-md-6"><input type="text" class="form-control" name="email" value="<?php echo $row['email']; ?>" placeholder="Email" disabled  required></div>
                </div>
				<div class="row mt-3">
                    <div class="col-md-6"><input type="text" class="form-control" name="qualification" value="<?php echo $row['qualification']; ?>" required placeholder="Qualification"></div>
                    <div class="col-md-6"><input type="text" class="form-control" name="exp" placeholder="Experience" value="<?php echo $row['exp']; ?>" 	></div>
                </div>
			...
			$name=$_POST['name'];
				$mob=$_POST['mob'];
							$qualification=$_POST['qualification'];
								...
								$upt="update addteacher set name='$name',mob='$mob',qualification='$qualification',exp='exp' where email='$email'";
