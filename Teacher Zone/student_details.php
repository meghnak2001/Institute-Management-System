...
if($con==true)
{
	...
	<thead><tr><th>Name</th><th>Mobile</th><th>Gender</th><th>Branch</th><th>Year</th><th>DOB</th><th>Address</th><th>District</th><th>Profile</th></tr></thead>";
		while($row=mysqli_fetch_array($result))
		{
		echo "<tr><td>".$row['sname']."</td><td>".$row['smob']."</td><td>".$row['gender']."</td><td>".$row['branch']."</td><td>".$row['year']."</td><td>".$row['DOB']."</td><td>".$row['c_address']."</td><td>".$row['district']."</td><td> <img src=simg/".$row['pic']." style='height:75px;width:75px;'></td></tr>";
		}
		echo "</table>";
}
?>
